...
const brands = [
        ...
        items: [
          {
            ...
            description:
              "5-minute quiz identifies what you already know and where to focus.",
          },
          {
            title: "Study Adaptively",
            description:
              "Listen to personalized lessons that target your weak areas first.",
          },
          {
            title: "Pass Your Exam",
            description:
              "Spaced repetition ensures you retain everything on test day.",
          },
        ],
      },
      faq: [
  ...
  },
  {
    ...
    landing: {
      ...
      bottomCta: {
        headline: "Ready to Start Studying?",
        subheadline:
          "Join thousands of electricians who passed their exam with audio-first learning.",
      },
    },
    seo: {
  ...
  },
  {
    ...
    landing: {
      ...
      bottomCta: {
        ...
        subheadline:
          "Join thousands of developers who leveled up their JavaScript with audio-first learning.",
      },
    },
    seo: {
        ...
        items: [
          {
            title: "Take a Diagnostic",
            description:
              "Quick assessment identifies what PostHog concepts you already know.",
          },
          {
            title: "Study Adaptively",
            description:
              "Lessons build from data modeling fundamentals to PostHog-specific architecture.",
          },
          {
            title: "Help Customers",
            description:
              "Deep technical understanding means faster, better customer conversations.",
          },
        ],
      },
      faq: [
  ...
  },
  {
    ...
    theme: {},
    landing: {
      hero: { headline: "Graspful", subheadline: "Adaptive learning", ctaText: "Get Started" },
      features: { heading: "Features", items: [] },
      howItWorks: { heading: "How it works", items: [] },
      faq: [],
    },
    seo: { title: "Graspful", description: "Adaptive learning platform", keywords: [] },
